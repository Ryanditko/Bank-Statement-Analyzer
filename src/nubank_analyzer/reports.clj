...
(comment
  ...
  (export-report analysis :txt "report.txt")
  (export-report analysis :json "report.json")
  (export-report analysis :html "report.html")

  ;; Export in all formats
  (export-all-formats analysis "reports/nubank"))
